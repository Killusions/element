...
??? info "Required Packages"
    ...
    The currently supported dependency versions can be found in the [package.json of the demo app](thttps://github.com/Killusions/element/blob/main/package.json).
