...
- **Playwright tests:** Stub the `tiles.json` request (and some others) using [page.route(...)](thttps://github.com/Killusions/element/tree/main/playwright/e2e/element-examples/maps/static.spec.ts).
