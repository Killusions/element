...
such as the [page header](thttps://github.com/Killusions/element/fundamentals/layouts/header.md),
the `h2` style is used instead for visual balance.

In this pattern, the `h1` tag is assigned to the application name in the [application header](thttps://github.com/Killusions/element/components/layout-navigation/application-header.md).
...
are defined in [_typography.scss](thttps://github.com/Killusions/element/tree/main/projects/element-theme/src/styles/variables/_typography.scss).
...
See [_semantic-tokens](thttps://github.com/Killusions/element/tree/main/projects/element-theme/src/styles/variables/_semantic-tokens.scss).
